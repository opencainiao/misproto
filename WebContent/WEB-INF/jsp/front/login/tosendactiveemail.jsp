...
<script type="text/javascript">
	$().ready(function() {
		...
		$(window.parent.document).find(".xubox_tabnow").html("发送激活邮件");
		...
		$("#send_email_btn").bind("click", function() {
			...
			var url_to = "<%=request.getContextPath()%>/senduseractiveemail";
		...
		<div class="Center-Block">
			<form id="send_email_form">
				...
				<div class="rlf-group clearfix">
					...
					<input type="button" id="send_email_btn" value="发送激活邮件" hidefocus="true"
						class="btn-red btn-full r"  style="font-size: 20px; font-weight: bold"/>
				</div>
			</form>
			
			<div id="success_div">
				<img alt="发送激活邮件成功" style="width: 160px; height: 160px;"
